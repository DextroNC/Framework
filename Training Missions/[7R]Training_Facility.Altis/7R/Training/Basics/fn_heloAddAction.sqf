...
_terminal addaction ["<t color=""#00FF00"">" +"Spawn Mi-8", fw_fnc_heloSpawn,["RHS_Mi8MTV3_vdv",_pad]];
_terminal addaction ["<t color=""#00FF00"">" +"Spawn AH64D", fw_fnc_heloSpawn,["RHS_AH64D_wd",_pad]];
_terminal addaction ["<t color=""#00FF00"">" +"Spawn MI-24g", fw_fnc_heloSpawn,["rhsgref_b_mi24g_CAS",_pad]];

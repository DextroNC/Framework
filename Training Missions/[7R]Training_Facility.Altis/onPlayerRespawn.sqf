...
if(_old getVariable ["sr_flightschool_pilotClass",0] == 1) then {
	_new setVariable ["sr_flightschool_pilotClass",1,true];
	[objNull, _new] call compile preProcessFileLineNumbers "7R\Training\FlightSchool\initialisePilot.sqf";
};

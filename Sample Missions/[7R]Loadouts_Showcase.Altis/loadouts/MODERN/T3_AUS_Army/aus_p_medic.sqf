...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_AUS_Army\aUniformCall.sqf";
...
comment "Add Backpack/Items";
    _unit addBackpack "UK3CB_ION_B_B_RIF_MED_BRN";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 7] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_AUS_Army\aWeaponCall.sqf";

...
[_unit, 4] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_AUS_Army\aUniformCall.sqf";
...
comment "Add Ammunition";
    ...
    for "_i" from 1 to 12 do {_unit addItemToVest "7r_mag_aug_m855a1";};

...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T1_BAF\T1_BAF_SAS\aUniformCall.sqf";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 4] call compile preprocessFileLineNumbers "loadouts\MODERN\T1_BAF\T1_BAF_SAS\aWeaponCall.sqf";

...
[_unit, 2] call compile preprocessFileLineNumbers "loadouts\MODERN\T1_BAF\T1_BAF_SAS\aUniformCall.sqf";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 8] call compile preprocessFileLineNumbers "loadouts\MODERN\T1_BAF\T1_BAF_SAS\aWeaponCall.sqf";
    _unit addPrimaryWeaponItem "rksl_optic_lds";
    _unit addPrimaryWeaponItem "uk3cb_baf_silencer_l85";
    _unit addPrimaryWeaponItem "uk3cb_underbarrel_acc_grippod";

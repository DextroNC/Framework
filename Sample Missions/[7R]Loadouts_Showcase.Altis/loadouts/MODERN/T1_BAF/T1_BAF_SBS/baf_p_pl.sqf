...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T1_BAF\T1_BAF_SBS\aUniformCall.sqf";
...
comment "Add Drip";
    _unit addItem selectRandom ["UK3CB_BAF_H_Beret_SBS","UK3CB_BAF_H_Beret_SBS_PRR","UK3CB_BAF_H_Beret_SBS_PRR_Over"];

comment "Add Primary/Attachments";
    // 1 - Rifle 1 | 2 - Rifle 2 | 3 - Grenadier | 4 - BattleRifle | 5 - AutoRifle | 6 - MMG
    [_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T1_BAF\T1_BAF_SBS\aWeaponCall.sqf";

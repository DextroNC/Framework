...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_US_MEU\T2_US_MEU_WD\aUniformCall.sqf";
...
comment "Add Backpack/Items";
    _unit addBackpack "UK3CB_ION_B_B_RadioBag_BRN";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 1] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_US_MEU\T2_US_MEU_WD\aWeaponCall.sqf";

...
[_unit, 1] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_US_MEU\T2_US_MEU_WD\aUniformCall.sqf";
...
comment "Add Weapons/Attachments";
    ...
    [_unit, 5] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_US_MEU\T2_US_MEU_WD\aWeaponCall.sqf";

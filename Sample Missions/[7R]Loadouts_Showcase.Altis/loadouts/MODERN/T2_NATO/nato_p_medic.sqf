...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_NATO\aUniformCall.sqf";
...
comment "Add Vest/Items";
    _unit addVest "JCA_MCRP_V_CarrierRigKBT_01_tactical_mtp_F";
...
comment "Add Drip";
    _unit addItemToBackpack "H_Booniehat_mcamo";

comment "Add Primary/Attachments";
    // 1 - Rifle 1 | 2 - Rifle 2 | 3 - Grenadier | 4 - BattleRifle | 5 - AutoRifle | 6 - MMG
    [_unit, 2] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_NATO\aWeaponCall.sqf";

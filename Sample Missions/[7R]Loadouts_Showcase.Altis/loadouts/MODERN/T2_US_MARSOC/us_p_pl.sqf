...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_US_MARSOC\aUniformCall.sqf";
...
comment "Add Vest/Items";
    _unit addVest "milgp_v_marciras_teamleader_belt_cb";
...
comment "Add Drip";
    _unit addItemToBackpack "VSM_M81_Cap";

comment "Add Primary/Attachments";
    // 1 - Rifle 1 | 2 - Rifle 2 | 3 - Grenadier | 4 - BattleRifle | 5 - AutoRifle | 6 - MMG
    [_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_US_MARSOC\aWeaponCall.sqf";

...
[_unit, 1] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_US_MARSOC\aUniformCall.sqf";
...
comment "Add Weapons/Attachments";
    ...
    [_unit, 5] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_US_MARSOC\aWeaponCall.sqf";

...
[_unit, 1] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_ESP_GOE\aUniformCall.sqf";
...
comment "Add Weapons/Attachments";
    ...
    [_unit, 5] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_ESP_GOE\aWeaponCall.sqf";

...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_MidEast_Militia\aUniformCall.sqf";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 4] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_MidEast_Militia\aWeaponCall.sqf";

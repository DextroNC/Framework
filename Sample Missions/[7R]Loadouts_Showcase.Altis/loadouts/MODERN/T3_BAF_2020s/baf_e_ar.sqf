...
[_unit, 1] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_BAF_2020s\aUniformCall.sqf";
...
comment "Add Weapons/Attachments";
    ...
    [_unit, 5] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_BAF_2020s\aWeaponCall.sqf";

if(isServer) then {
	...
	bigBox addmagazinecargoGlobal ["rhsusf_100Rnd_762x51", 80];
    bigBox addmagazinecargoGlobal ["rhsusf_mag_17Rnd_9x19_JHP", 60];
    bigBox addweaponcargoGlobal ["rhs_weap_m136_hedp", 20];
    bigBox addweaponcargoGlobal ["launch_NLAW_F", 10];

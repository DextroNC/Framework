...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T1_US_Green_berets\aUniformCall.sqf";
...
comment "Add Vest/Items";
    _unit addVest "milgp_v_jpc_teamleader_belt_mc";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T1_US_Green_berets\aWeaponCall.sqf";

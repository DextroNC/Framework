eqBox addaction ["<t color=""#FFFF00"">" +"Suppressor - 5.56mm", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_nt4_black"]];
eqBox addaction ["<t color=""#FFFF00"">" +"Suppressor - 7.62mm", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_aac_762sdn6_silencer"]];
...
eqBox addaction ["<t color=""#00FF00"">" +"EOT552 (Tan)", "7R\Loadouts\7R_EQ.sqf",["RKSL_optic_EOT552_c"]];
...
eqBox addaction ["<t color=""#FF8C00"">" +"ACOG (Tan)", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_acog_d"]];
...
eqBox addaction ["<t color=""#FF8C00"">" +"SU-230 - 5.56mm (Tan)", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230_c"]];
eqBox addaction ["<t color=""#FF8C00"">" +"SU-230 MRDS - 5.56mm (Tan)", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230_mrds_c"]];;
eqBox addaction ["<t color=""#FF8C00"">" +"SU-230 - 7.62mm (Tan)", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230a_c"]];
eqBox addaction ["<t color=""#FF8C00"">" +"SU-230 MRDS - 7.62mm (Tan)", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230a_mrds_c"]];
...
// Support items
[eqBox, 1] call fw_fnc_addEquipmentItems;

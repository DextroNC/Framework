...
[_unit, 2] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_US_Marines\aUniformCall.sqf";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 10] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_US_Marines\aWeaponCall.sqf";

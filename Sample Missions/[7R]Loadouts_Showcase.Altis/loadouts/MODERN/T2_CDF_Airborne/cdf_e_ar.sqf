...
[_unit, 1] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_CDF_Airborne\aUniformCall.sqf";
...
comment "Add Weapons/Attachments";
    ...
    [_unit, 5] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_CDF_Airborne\aWeaponCall.sqf";

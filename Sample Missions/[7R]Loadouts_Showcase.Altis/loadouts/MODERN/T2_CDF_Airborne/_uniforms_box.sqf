_uniforms = [
	...
	["Platoon", "#ffff00", "a3\ui_f\data\Map\Markers\NATO\b_hq.paa",
		[["Platoon Leader", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_pl.sqf"],
		["Platoon FAC", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_fac.sqf"],
		["Platoon Engineer (Demo)", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_e_demo.sqf"],
		["Platoon Engineer (EOD)", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_e_eod.sqf"],
		["Platoon Engineer (Fortification)", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_e_fort.sqf"],
		["Platoon Engineer (Repair)", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_e_repair.sqf"],
		["Platoon DMR", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_dmr.sqf"],
		["Platoon UAV Operator", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_uav.sqf"],
		["Platoon Driver", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_driver.sqf"],
		["Platoon AR", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_ar.sqf"],
		["Platoon Medic", "loadouts\MODERN\T2_CDF_Airborne\cdf_p_medic.sqf"]
	]],

	["Infantry", "#00ff00", "a3\ui_f\data\Map\Markers\NATO\b_inf.paa",
		[["Squad Leader", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_sl.sqf"],
		["Combat Medic", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_medic.sqf"],
		["Operator Rifleman", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_rifleman.sqf"],
		["Operator AR", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_ar.sqf"],
		["Operator LAT", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_lat.sqf"],
		["Operator LAT (NLAW)", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_lat2.sqf"],
		["Operator MMG", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_mmg.sqf"],
		["Operator Asst. MMG", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_mmgAsst.sqf"],
		["Operator MAT", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_mat.sqf"],
		["Operator Asst. MAT", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_matAsst.sqf"]
	]],
	...
	["Specialists", "#00ff00", "a3\ui_f\data\Map\Markers\NATO\b_inf.paa",
		...
		["Operator Engineer (Fortification)", "loadouts\MODERN\T2_CDF_Airborne\cdf_o_e_fort.sqf"],
	...
	["Foxtrot", "#ff0000", "a3\ui_f\data\Map\Markers\NATO\b_armor.paa",
		[["Fox Commander", "loadouts\MODERN\T2_CDF_Airborne\cdf_f_com.sqf"],
		["Fox Crewman", "loadouts\MODERN\T2_CDF_Airborne\cdf_f_crew.sqf"],
		["Fox Technician", "loadouts\MODERN\T2_CDF_Airborne\cdf_f_tech.sqf"]
	]],

	["Sierra", "#ff0000", "a3\ui_f\data\Map\Markers\NATO\b_recon.paa",
		[["Sierra Spotter", "loadouts\MODERN\T2_CDF_Airborne\cdf_s_spotter.sqf"],
		["Sierra Sniper", "loadouts\MODERN\T2_CDF_Airborne\cdf_s_sniper.sqf"],
		["Sierra Sniper (M82A1)", "loadouts\MODERN\T2_CDF_Airborne\cdf_s_sniper2.sqf"],
		["Sierra Recon", "loadouts\MODERN\T2_CDF_Airborne\cdf_s_recon.sqf"]
	]],

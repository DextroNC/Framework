eqBox addaction ["<t color=""#00FFFF"">" +"Switch Optics Mount", "loadouts\MODERN\T2_CDF_Airborne\optic_switch.sqf"];
...
eqBox addaction ["<t color=""#FF8C00"">" +"NIT-A (AK-Mount)", "7R\Loadouts\7R_EQ.sqf",["rhs_acc_nita"]];

...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_AAF_2020s\aUniformCall.sqf";
...
comment "Add Backpack/Items";
    _unit addBackpack "UK3CB_AAF_B_B_CARRYALL_DIGI_BRN";

comment "Add Drip";
    _unit addItemToBackpack "H_Booniehat_dgtl";

comment "Add Primary/Attachments";
    // 1 - Rifle 1 | 2 - Rifle 2 | 3 - Grenadier | 4 - BattleRifle | 5 - AutoRifle | 6 - MMG
    [_unit, 2] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_AAF_2020s\aWeaponCall.sqf";

...
[_unit, 2] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_US_75th_Rangers\aUniformCall.sqf";
...
comment "Add Vest/Items";
    _unit addVest "milgp_v_mmac_teamleader_belt_MC";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 3] call compile preprocessFileLineNumbers "loadouts\MODERN\T2_US_75th_Rangers\aWeaponCall.sqf";

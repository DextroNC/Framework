...
[_unit, 2] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_US_Army\aUniformCall.sqf";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 10] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_US_Army\aWeaponCall.sqf";

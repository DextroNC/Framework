...
comment "Add Backpack/Items";
    _unit addBackpack "UK3CB_ION_B_B_RadioBag_BLK";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 1] call compile preprocessFileLineNumbers "loadouts\MODERN\T1_US_DEVGRU\T1_US_DEVGRU_BO\aWeaponCall.sqf";

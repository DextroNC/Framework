...
[_unit, 2] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_CDF_2020s\aUniformCall.sqf";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 10] call compile preprocessFileLineNumbers "loadouts\MODERN\T3_CDF_2020s\aWeaponCall.sqf";

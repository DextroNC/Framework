...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\RETRO\T3_USMC_2000s\aUniformCall.sqf";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 2] call compile preprocessFileLineNumbers "loadouts\RETRO\T3_USMC_2000s\aWeaponCall.sqf";

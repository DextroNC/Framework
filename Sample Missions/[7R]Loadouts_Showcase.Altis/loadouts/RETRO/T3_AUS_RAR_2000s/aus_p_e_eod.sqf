...
[_unit, 3] call compile preprocessFileLineNumbers "loadouts\RETRO\T3_AUS_RAR_2000s\aUniformCall.sqf";
...
comment "Add Drip";
    _unit addItemToBackpack "7r_dpcu_patrolcap";

comment "Add Primary/Attachments";
    // 1 - Rifle 1 | 2 - Rifle 2 | 3 - Grenadier | 4 - BattleRifle | 5 - AutoRifle | 6 - MMG
    [_unit, 4] call compile preprocessFileLineNumbers "loadouts\RETRO\T3_AUS_RAR_2000s\aWeaponCall.sqf";

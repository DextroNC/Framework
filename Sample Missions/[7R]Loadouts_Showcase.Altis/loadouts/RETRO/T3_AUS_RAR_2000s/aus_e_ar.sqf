...
[_unit, 1] call compile preprocessFileLineNumbers "loadouts\RETRO\T3_AUS_RAR_2000s\aUniformCall.sqf";
...
comment "Add Weapons/Attachments";
    ...
    [_unit, 5] call compile preprocessFileLineNumbers "loadouts\RETRO\T3_AUS_RAR_2000s\aWeaponCall.sqf";

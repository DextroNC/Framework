...
[_unit, 2] call compile preprocessFileLineNumbers "loadouts\RETRO\T3_US_Army_80s_90s\aUniformCall.sqf";
...
comment "Add Vest/Items";
    _unit addVest "UK3CB_CW_US_B_LATE_V_PASGT_Medic_Vest";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 1] call compile preprocessFileLineNumbers "loadouts\RETRO\T3_US_Army_80s_90s\aWeaponCall.sqf";

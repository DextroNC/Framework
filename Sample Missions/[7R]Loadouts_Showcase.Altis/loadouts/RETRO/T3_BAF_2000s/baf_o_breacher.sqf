...
[_unit, 2] call compile preprocessFileLineNumbers "loadouts\RETRO\T3_BAF_2000s\aUniformCall.sqf";
...
comment "Add Primary/Attachments";
    ...
    [_unit, 10] call compile preprocessFileLineNumbers "loadouts\RETRO\T3_BAF_2000s\aWeaponCall.sqf";

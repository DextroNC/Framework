call compile preprocessFileLineNumbers "swaps\swaps_T2_US_75th_Rangers.sqf";
...
this addaction ["<t color=""#FFFF00"">" +"Swap to MARSOC (T2)", "swaps\swaps_T2_US_MARSOC.sqf"];
this addaction ["<t color=""#FFFF00"">" +"Swap to MEU (T2)", "swaps\swaps_T2_US_MEU.sqf"];
this addaction ["<t color=""#FFFF00"">" +"Swap to AAF - 2020s (T3)", "swaps\swaps_T3_AAF_2020s.sqf"];
this addaction ["<t color=""#FFFF00"">" +"Swap to BAF - 2020s (T3)", "swaps\swaps_T3_BAF_2020s.sqf"];
this addaction ["<t color=""#FFFF00"">" +"Swap to CDF - 2020s (T3)", "swaps\swaps_T3_CDF_2020s.sqf"];
this addaction ["<t color=""#FFFF00"">" +"Swap to Australian Army (T3)", "swaps\swaps_T3_AUS_Army.sqf"];
this addaction ["<t color=""#FFFF00"">" +"Swap to US Army (T3)", "swaps\swaps_T3_US_Army.sqf"];
this addaction ["<t color=""#FFFF00"">" +"Swap to US Marines (T3)", "swaps\swaps_T3_US_Marines.sqf"];
this addaction ["<t color=""#FFFF00"">" +"Swap to Western PMC (T3)", "swaps\swaps_T3_Western_PMC.sqf"];
this addaction ["<t color=""#FFFF00"">" +"Swap to Middle East Militia (T3)", "swaps\swaps_T3_MEM.sqf"];

...
_action = ["7R_EZA","Liftoff","a3\ui_f\data\IGUI\Cfg\simpleTasks\types\heli_ca.paa",{
...
_selfAction = ["7R_EZA","Liftoff","a3\ui_f\data\IGUI\Cfg\simpleTasks\types\heli_ca.paa",{

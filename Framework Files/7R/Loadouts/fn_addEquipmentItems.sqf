...
if (_tier <= 3) then {
    ...
    _terminal addaction ["<t color=""#FF0000"">Laserdesignator", "7R\Loadouts\7R_EQ.sqf", ["Laserdesignator"]];
};

_terminal addaction ["<t color=""#FF0000"">Lockpick", "7R\Loadouts\7R_EQ.sqf", ["ACE_key_lockpick"]];
_terminal addaction ["<t color=""#FF0000"">Entreching Tool", "7R\Loadouts\7R_EQ.sqf", ["ACE_EntrenchingTool"]];

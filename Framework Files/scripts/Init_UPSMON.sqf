...
UPSMON_sharedist = 700; // org value 800 => increased for ArmA3 map sizes for less predictable missions..
...
UPSMON_EAST_SURRENDER = 20;
UPSMON_GUER_SURRENDER = 20;

// Default Freeing Value
UPSMON_FLEE = 0.5;

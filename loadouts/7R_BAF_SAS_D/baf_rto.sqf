...
_unit forceAddUniform "UK3CB_BAF_U_CombatUniform_DDPM_ShortSleeve";
...
_unit addHeadgear "UK3CB_BAF_H_Earphone";
_unit addGoggles "shemagh_goggblk_tan";
...
if (SR_Night) then {
	...
	_unit addHeadgear "UK3CB_BAF_H_Mk6_DDPM_C";

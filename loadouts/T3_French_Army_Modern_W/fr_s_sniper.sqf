...
_unit forceAddUniform "AMF_Uniform_gh_ce";
...
comment "Add weapons";
_unit addWeapon "AMF_Perseis_II_01_F";
...
for "_i" from 1 to 6 do {_unit addItemToVest "7Rnd_Perseis_II_mag";};
for "_i" from 1 to 2 do {_unit addItemToVest "7Rnd_Perseis_II_mag";};

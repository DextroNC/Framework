...
this addaction ["Platoon Asst. AR", "loadouts\rus_p_ar_ab.sqf"];
...
this addaction ["Operator Battlerifle (AK-104)", "loadouts\rus_o_br.sqf"];
this addaction ["Operator Specialist (AS Val)", "loadouts\rus_o_spc.sqf"];
this addaction ["Operator Breacher", "loadouts\rus_o_breacher.sqf"];
...
this addaction ["Echo Asst. AR", "loadouts\rus_e_ar_ab.sqf"];

...
_unit forceAddUniform "usm_bdu_des_m";
...
_unit addVest "usm_vest_pasgt_lbe_rmp";
for "_i" from 1 to 3 do {_unit addItemToVest "SmokeShell";};
for "_i" from 1 to 2 do {_unit addItemToVest "SmokeShellYellow";};
_unit addItemToVest "rhsusf_m112_mag";
_unit addBackpack "UK3CB_CW_US_B_LATE_B_RIF_02";
...
_unit addItemToBackpack "usm_bdu_8point_des_m";

comment "Add weapons";
_unit addWeapon "UK3CB_M14_Railed";
...
if (SR_Night) then {
	...
	_unit addHeadgear "usm_helmet_pasgt_m_rm_des";   

...
_unit forceAddUniform "usm_bdu_srh_des_m";
...
for "_i" from 1 to 9 do {_unit addItemToVest "rhsusf_5Rnd_00Buck";};
for "_i" from 1 to 9 do {_unit addItemToVest "rhsusf_5Rnd_Slug";};

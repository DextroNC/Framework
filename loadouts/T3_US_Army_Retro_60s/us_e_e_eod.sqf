...
_unit addHeadgear "rhsgref_helmet_M1_bare_alt01";
...
for "_i" from 1 to 10 do {_unit addItemToVest "UK3CB_M16_20Rnd_Mag";};
for "_i" from 1 to 8 do {_unit addItemToBackpack "UK3CB_M16_20Rnd_Mag";};

...
_unit forceAddUniform "usm_bdu_wdl";
...
_unit addHeadgear "usm_helmet_pasgt_ce_wdl";
_unit addItemToBackpack "usm_bdu_8point_erdl";

comment "Add weapons";
_unit addWeapon "rhs_weap_m14_ris_wd";

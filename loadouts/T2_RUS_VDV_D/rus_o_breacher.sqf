...
_unit addHeadgear "UK3CB_TKA_O_H_6b27m_Surpat";
...
for "_i" from 1 to 4 do {_unit addItemToVest "rhs_30Rnd_545x39_7N22_desert_AK";};
for "_i" from 1 to 4 do {_unit addItemToBackpack "rhs_30Rnd_545x39_7N22_desert_AK";};

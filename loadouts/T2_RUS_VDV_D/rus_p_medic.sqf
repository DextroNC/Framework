...
_unit addVest "UK3CB_TKA_O_V_6b23_medic_Surpat";
...
for "_i" from 1 to 10 do {_unit addItemToVest "rhs_30Rnd_545x39_7N22_plum_AK";};
for "_i" from 1 to 2 do {_unit addItemTobackpack "rhs_30Rnd_545x39_7N22_plum_AK";};
...
if (SR_Night) then {
	...
	_unit addHeadgear "UK3CB_TKA_O_H_6b27m_ESS_Surpat";
};

...
_unit addVest "UK3CB_AAF_I_V_Falcon_9_DIGI_BRN";
...
_unit addHeadgear "VSM_Mich2000_ProjectHonor";
...
for "_i" from 1 to 4 do {_unit addItemToVest "rhs_mag_30Rnd_556x45_Mk262_Stanag_Pull";};
for "_i" from 1 to 4 do {_unit addItemToBackpack "rhs_mag_30Rnd_556x45_Mk262_Stanag_Pull";};

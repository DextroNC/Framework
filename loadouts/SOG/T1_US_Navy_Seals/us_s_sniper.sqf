...
comment "Add Vest/Items";
    _unit addVest "vn_b_vest_seal_03";
...
comment "Add Ammunition";
    for "_i" from 1 to 4 do {_unit addItemToUniform "vn_mk22_mag";};
    for "_i" from 1 to 10 do {_unit addItemToVest "vn_m40a1_mag";};

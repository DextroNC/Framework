...
// Infantry Supply
if (_type == 1) then {
	_box addmagazinecargoGlobal ["vn_m63a_30_mag", 72];
	_box addmagazinecargoGlobal ["vn_m16_30_mag", 54];
	_box addmagazinecargoGlobal ["vn_m45_mag", 24];
	_box addmagazinecargoGlobal ["vn_mk22_mag", 24];
	_box addmagazinecargoGlobal ["vn_m63a_100_mag", 24];
	...
	_box addmagazinecargoGlobal ["vn_m45_mag", 18];
...
if (_type == 3) then {
	...
	_box addmagazinecargoGlobal ["vn_m63a_30_mag", 12];
	_box addmagazinecargoGlobal ["vn_mk22_mag", 8];
};

// Small Squad Supply
if (_type == 4) then {
	_box addmagazinecargoGlobal ["vn_m63a_30_mag", 36];
	_box addmagazinecargoGlobal ["vn_m16_30_mag", 27];
	_box addmagazinecargoGlobal ["vn_m45_mag", 12];
	_box addmagazinecargoGlobal ["vn_m63a_100_mag", 12];
    _box addmagazinecargoGlobal ["vn_m14_mag", 8];
	_box addmagazinecargoGlobal ["vn_mk22_mag", 8];
	_box addWeaponWithAttachmentsCargoGlobal [["vn_m72","","","",["vn_m72_mag",1],[],""], 2];
...
if (_type == 5) then {
	_box addmagazinecargoGlobal ["vn_m14_mag", 8];
	_box addmagazinecargoGlobal ["vn_m45_mag", 9];

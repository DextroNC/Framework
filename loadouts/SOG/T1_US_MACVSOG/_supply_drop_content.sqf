...
// Infantry Supply
if (_type == 1) then {
	_box addmagazinecargoGlobal ["vn_m16_30_mag", 72];
	...
	_box addmagazinecargoGlobal ["vn_m1a1_30_mag", 18];
...
if (_type == 3) then {
	...
	_box addmagazinecargoGlobal ["vn_m16_30_mag", 12];
	_box addmagazinecargoGlobal ["vn_hp_mag", 8];
};

// Small Squad Supply
if (_type == 4) then {
	_box addmagazinecargoGlobal ["vn_m16_30_mag", 36];
...
if (_type == 5) then {
	_box addmagazinecargoGlobal ["vn_m14_mag", 8];
	_box addmagazinecargoGlobal ["vn_m1a1_30_mag", 9];

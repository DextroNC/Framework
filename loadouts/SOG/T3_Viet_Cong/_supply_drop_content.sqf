...
if (_type == 1) then {
	...
	_box addmagazinecargoGlobal ["vn_sks_mag", 10];
	_box addmagazinecargoGlobal ["vn_rpg2_mag", 10];
	_box additemcargoGlobal ["vn_rg42_grenade_mag", 8];
	...
	_box additemcargoGlobal ["vn_rg42_grenade_mag", 10];
...
if (_type == 3) then {
	...
	_box addmagazinecargoGlobal ["vn_sks_mag", 12];
	_box addmagazinecargoGlobal ["vn_m10_mag", 8];
};
...
if (_type == 4) then {
	...
	_box addmagazinecargoGlobal ["vn_m10_mag", 8];
	_box additemcargoGlobal ["vn_rg42_grenade_mag", 6];
...
if (_type == 5) then {
	...
	_box addmagazinecargoGlobal ["vn_mat49_mag", 9];

...
comment "Add Uniforms/Items";
    _unit forceAddUniform "vn_b_uniform_k2b_03_02";
...
comment "Add Drip";
    _unit addHeadgear selectRandom ["vn_b_helmet_svh4_01_04","vn_b_helmet_svh4_02_04","vn_b_helmet_svh4_01_06","vn_b_helmet_svh4_02_06"];

comment "Add Primary/Attachments";
    _unit addWeapon "vn_f1_smg";
...
comment "Add Ammunition";
    for "_i" from 1 to 1 do {_unit addItemToUniform "vn_hp_mag";};
    for "_i" from 1 to 3 do {_unit addItemToVest "vn_f1_smg_mag";};

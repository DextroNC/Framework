...
comment "Add Uniforms/Items";
    _unit forceAddUniform "vn_o_uniform_nva_army_01_04";
...
comment "Add Drip";
    _unit addHeadgear "vn_o_helmet_tsh3_02";
...
comment "Add Ammunition";
    for "_i" from 1 to 1 do {_unit addItemToVest "vn_tt33_mag";};
    for "_i" from 1 to 4 do {_unit addItemToVest "vn_pps52_mag";};

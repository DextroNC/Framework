...
comment "Add Vest/Items";
    _unit addVest "vn_b_vest_usmc_01";
...
comment "Add Backpack/Items";
    ...
    for "_i" from 1 to 4 do {_unit addItemToBackpack "vn_mine_m18_range_mag";};
    for "_i" from 1 to 2 do {_unit addItemToBackpack "vn_mine_m15_mag";};
    for "_i" from 1 to 5 do {_unit addItemToBackpack "ACE_Fortication_Material";};

comment "Add Drip";
    _unit addItemToBackpack selectRandom ["vn_b_bandana_01","H_Cap_blk","vn_b_boonie_02_01","vn_b_boonie_03_01","vn_b_boonie_04_01","vn_b_boonie_05_01","vn_b_boonie_01_01","vn_b_headband_01","vn_b_headband_04","vn_b_headband_03"];

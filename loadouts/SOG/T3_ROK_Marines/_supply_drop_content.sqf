...
// Infantry Supply
if (_type == 1) then {
	_box addmagazinecargoGlobal ["vn_m1_garand", 72];
	_box addmagazinecargoGlobal ["vn_carbine_30_mag", 36];
	_box addmagazinecargoGlobal ["vn_m1918_mag", 30];
	_box addmagazinecargoGlobal ["vn_m1911_mag", 24];
    _box addmagazinecargoGlobal ["UK3CB_M1919_50Rnd_3006_Magazine_RM", 10];
	_box addmagazinecargoGlobal ["vn_m1897_buck_mag", 30];
	_box addmagazinecargoGlobal ["vn_m1897_fl_mag", 30];
	_box addmagazinecargoGlobal ["vn_m1903_mag", 20];
	_box addmagazinecargoGlobal ["vn_m16_20_mag", 24];
...
// Sierra Supply
if (_type == 3) then {
	_box addmagazinecargoGlobal ["vn_m40a1_mag", 10];
	_box addmagazinecargoGlobal ["vn_m1_garand", 12];
	_box addmagazinecargoGlobal ["vn_m1911_mag", 8];
};

// Small Squad Supply
if (_type == 4) then {
	_box addmagazinecargoGlobal ["vn_m1_garand", 36];
	_box addmagazinecargoGlobal ["vn_carbine_30_mag", 18];
	_box addmagazinecargoGlobal ["vn_m1918_mag", 15];
	_box addmagazinecargoGlobal ["UK3CB_M1919_50Rnd_3006_Magazine_RM", 6];
    _box addmagazinecargoGlobal ["vn_m1903_mag", 8];
	_box addmagazinecargoGlobal ["vn_m16_20_mag", 12];
	_box addmagazinecargoGlobal ["vn_m1911_mag", 8];
	_box addWeaponWithAttachmentsCargoGlobal [["vn_m72","","","",["vn_m72_mag",1],[],""], 2];
...
if (_type == 5) then {
	_box addmagazinecargoGlobal ["vn_m1903_mag", 8];
	_box addmagazinecargoGlobal ["UK3CB_M1919_50Rnd_3006_Magazine_RM", 5];

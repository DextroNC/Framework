if(isServer) then {
	...
	this addmagazinecargoGlobal ["vn_m1918_mag", 60];
	this addmagazinecargoGlobal ["UK3CB_M1919_50Rnd_3006_Magazine_RM", 40];
    this addmagazinecargoGlobal ["vn_m1911_mag", 60];
	...
	this addmagazinecargoGlobal ["vn_m20a1b1_heat_mag", 20];
	this addmagazinecargoGlobal ["vn_m20a1b1_wp_mag", 10];

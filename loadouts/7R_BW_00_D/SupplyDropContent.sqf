...
if (_type == 1) then {
	...
	_box addmagazinecargoGlobal ["rhs_200rnd_556x45_M_SAW", 16];
...
if (_type == 3) then {
	...
	clearitemcargoGlobal _box; 
	clearBackpackCargoGlobal _box; 
	_box addmagazinecargoGlobal ["UK3CB_BAF_1Rnd_60mm_Mo_Shells", 30];
	_box addmagazinecargoGlobal ["UK3CB_BAF_1Rnd_60mm_Mo_Smoke_White", 8];
	_box addmagazinecargoGlobal ["UK3CB_BAF_1Rnd_60mm_Mo_Flare_White", 8];

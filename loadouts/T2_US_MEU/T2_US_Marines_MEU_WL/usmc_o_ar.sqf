...
_unit addHeadgear "milgp_h_opscore_02_CB";
...
for "_i" from 1 to 2 do {_unit addItemToVest "rhsusf_200Rnd_556x45_M855_mixed_soft_pouch_coyote";};
for "_i" from 1 to 3 do {_unit addItemToBackpack "rhsusf_200Rnd_556x45_M855_mixed_soft_pouch_coyote";};

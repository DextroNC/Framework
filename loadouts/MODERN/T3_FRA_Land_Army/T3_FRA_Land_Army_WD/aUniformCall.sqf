...
//Appends array of uniforms with desired uniforms based on _Class
    ...
    if (_Class == 1) then{
        _uniformArray = [
            "7r_field_uniform_cce",
            "7r_field_uniform_cce",
            "7r_field_uniform_cce",
            "7r_field_uniform_cce_ssl",
            "7r_field_uniform_cce_ssl",
            "7r_field_uniform_cce_ssl",
            "7r_field_uniform_cce_tee"
        ];
    };
...
//Appends array of hats with desired uniforms based on _Class
    ...
    //Squad
    if (_Class == 2) then{
        _hatArray = _ess_list + _noess_list + ["7r_ach_netting_cce","7r_ach_netting_cce","7r_ach_netting_cce","7r_ach_netting_cce","7r_ach_netting_cce","7r_ach_netting_cce","7r_ach_netting_cce","7r_ach_netting_cce"];;
    };

...
if (_type == 1) then {
	...
	_box addmagazinecargoGlobal ["30Rnd_65x39_caseless_khaki_mag", 90];
	_box addmagazinecargoGlobal ["50Rnd_570x28_SMG_03", 10];
	_box addmagazinecargoGlobal ["16Rnd_9x21_Mag", 24];
	_box addmagazinecargoGlobal ["100Rnd_65x39_caseless_khaki_mag_tracer", 40];
...
if (_type == 3) then {
	...
	_box addmagazinecargoGlobal ["30Rnd_65x39_caseless_khaki_mag", 12];

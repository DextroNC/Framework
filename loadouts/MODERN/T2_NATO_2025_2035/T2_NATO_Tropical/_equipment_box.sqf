this addaction ["<t color=""#FFFF00"">" +"Suppressor - 6.5mm", "7R\Loadouts\7R_EQ.sqf",["muzzle_snds_H"]];
this addaction ["<t color=""#FFFF00"">" +"Suppressor - 7.62mm", "7R\Loadouts\7R_EQ.sqf",["muzzle_snds_B"]];
this addaction ["<t color=""#FFFF00"">" +"Suppressor - .338", "7R\Loadouts\7R_EQ.sqf",["muzzle_snds_338_black"]];
this addaction ["<t color=""#FFFF00"">" +"Suppressor - 9mm", "7R\Loadouts\7R_EQ.sqf",["muzzle_snds_L"]];

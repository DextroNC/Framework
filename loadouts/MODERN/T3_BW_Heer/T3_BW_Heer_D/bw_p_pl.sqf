...
comment "Add Vest/Items";
    _unit addVest selectRandom ["7r_tropen_modvest_crew","7r_tropen_modvest_cqb","7r_tropen_modvest_cqb"];
...
comment "Add Backpack/Items";
    _unit addBackpack "7r_fieldpack_tropen";
    for "_i" from 1 to 2 do {_unit addItemToBackpack "DemoCharge_Remote_Mag";};
    _unit addItemToBackpack "ACE_HuntIR_monitor";
    for "_i" from 1 to 4 do {_unit addItemToBackpack "ACE_HuntIR_M203";};

comment "Add Drip";
    _unit addItemToBackpack selectRandom ["7r_beret_bw_army_prr","7r_beret_bw_army_prr_over"];

...
if (_type == 1) then {
	...
	_box addmagazinecargoGlobal ["30Rnd_9x21_Mag_SMG_02", 24];
	_box addmagazinecargoGlobal ["rhsusf_mag_17Rnd_9x19_JHP", 24];
	_box addmagazinecargoGlobal ["rhsusf_200Rnd_556x45_soft_pouch", 12];
	...
	_box addmagazinecargoGlobal ["rhs_mag_20Rnd_SCAR_762x51_m80a1_epr_bk", 20];
...
if (_type == 4) then {
	...
	_box addmagazinecargoGlobal ["30Rnd_9x21_Mag_SMG_02", 12];
	_box addmagazinecargoGlobal ["rhsusf_200Rnd_556x45_soft_pouch", 6];
    _box addmagazinecargoGlobal ["rhs_mag_20Rnd_SCAR_762x51_m80a1_epr_bk", 10];
	_box addmagazinecargoGlobal ["rhsusf_mag_17Rnd_9x19_JHP", 8];

...
this addaction ["<t color=""#00FF00"">" +"M552 camo", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_eotech_552_d"]];
...
this addaction ["<t color=""#FF8C00"">" +"ACOG camo", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_ACOG_d"]];
this addaction ["<t color=""#FF8C00"">" +"EXPS3 + G33", "7R\Loadouts\7R_EQ.sqf",["RH_eothhs1"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 - 5.56", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 MRDS - 5.56", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230_mrds"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 tan - 5.56", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230_c"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 MRDS tan - 5.56", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230_mrds_c"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 - 7.62", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230a"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 MRDS - 7.62", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230a_mrds"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 tan - 7.62", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230a_c"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 MRDS tan - 7.62", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230a_mrds_c"]];
...
this addaction ["<t color=""#ffff00"">" +"suppressor - HK416", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_rotex5_grey"]];
this addaction ["<t color=""#ffff00"">" +"suppressor - SCAR H", "7R\Loadouts\7R_EQ.sqf",["RH_Saker762"]];

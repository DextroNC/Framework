...
_unit addVest "milgp_v_marciras_grenadier_cb";
...
comment "Add weapons";
_unit addWeapon "rhs_weap_hk416d10_m320_wd"; 
...
for "_i" from 1 to 2 do {_unit addItemToBackpack "rhs_mag_30Rnd_556x45_M855A1_PMAG";};

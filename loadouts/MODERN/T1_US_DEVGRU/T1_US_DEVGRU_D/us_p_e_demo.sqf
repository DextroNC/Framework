...
_unit addVest "milgp_v_mmac_marksman_belt_KHK";
...
_unit addItemToBackpack "milgp_h_cap_backwards_03_khk";
...
for "_i" from 1 to 11 do {_unit addItemToVest "rhs_mag_20Rnd_SCAR_762x51_m80_ball";};

...
switch (_index) do {
	...
	case 3: {
		_vehicle addItemCargoGlobal ["SR_PAK", 4];
		_vehicle addMagazineCargoGlobal ["UK3CB_BAF_Javelin_Slung_Tube", 2];
		_vehicle addbackpackcargoGlobal ["RHS_Kornet_Gun_Bag", 1];
	    _vehicle addbackpackcargoGlobal ["RHS_Kornet_Tripod_Bag", 1];

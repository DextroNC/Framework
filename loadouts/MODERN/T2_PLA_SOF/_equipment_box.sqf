...
this addaction ["<t color=""#FFFF00"">" +"Suppressor - 5.8mm", "7R\Loadouts\7R_EQ.sqf",["muzzle_snds_58_blk_F"]];
this addaction ["<t color=""#FFFF00"">" +"Suppressor - SVDM", "7R\Loadouts\7R_EQ.sqf",["rhs_acc_tgpv2"]];

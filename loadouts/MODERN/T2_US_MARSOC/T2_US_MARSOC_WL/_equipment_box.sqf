...
this addaction ["<t color=""#00FF00"">" +"M552 camo", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_eotech_552_wd"]];
...
this addaction ["<t color=""#FF8C00"">" +"ACOG camo", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_ACOG_wd"]];

...
// Infantry Supply
if (_type == 1) then {
	_box addmagazinecargoGlobal ["rhs_mag_30Rnd_556x45_Mk262_Stanag_Ranger", 72];
	_box addmagazinecargoGlobal ["9Rnd_45ACP_Mag", 42];
	...
	_box addmagazinecargoGlobal ["rhs_mag_20Rnd_SCAR_762x51_m80_ball", 10];
...
// Small Squad Supply
if (_type == 4) then {
	_box addmagazinecargoGlobal ["rhs_mag_30Rnd_556x45_Mk262_Stanag_Ranger", 36];

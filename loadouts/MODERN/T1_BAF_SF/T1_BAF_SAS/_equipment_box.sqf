...
this addaction ["<t color=""#00FF00"">" +"EOT552 (Tan)", "7R\Loadouts\7R_EQ.sqf",["RKSL_optic_EOT552_c"]];
...
this addaction ["<t color=""#FF8C00"">" +"SU-230 - 5.56mm (Tan)", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230_c"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 MRDS - 5.56mm (Tan)", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230_mrds_c"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 - 7.62mm (Tan)", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230a_c"]];
this addaction ["<t color=""#FF8C00"">" +"SU-230 MRDS - 7.62mm (Tan)", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230a_mrds_c"]];
this addaction ["<t color=""#FF8C00"">" +"AR/MMG sight - Elcan LDS", "7R\Loadouts\7R_EQ.sqf",["RKSL_optic_LDS"]];

...
this addaction ["Operator MMG (MG3)", "loadouts\bw_o_mmg_mg3.sqf"];
this addaction ["Operator MMG (MG5)", "loadouts\bw_o_mmg_mg5.sqf"];
this addaction ["Operator Asst. MMG (MG3)", "loadouts\bw_o_mmg_ab_3.sqf"];
this addaction ["Operator Asst. MMG (MG5)", "loadouts\bw_o_mmg_ab_5.sqf"];
...
this addaction ["Operator Specialist (HK416)", "loadouts\bw_o_spc.sqf"];

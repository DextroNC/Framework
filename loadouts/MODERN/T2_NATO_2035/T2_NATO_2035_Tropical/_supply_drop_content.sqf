...
// Infantry Supply
if (_type == 1) then {
	_box addmagazinecargoGlobal ["30Rnd_65x39_caseless_khaki_mag", 72];
	_box addmagazinecargoGlobal ["16Rnd_9x21_Mag", 42];
	_box addmagazinecargoGlobal ["100Rnd_65x39_caseless_khaki_mag_tracer", 12];
	_box addmagazinecargoGlobal ["130Rnd_338_Mag", 8];
	_box addmagazinecargoGlobal ["20Rnd_762x51_Mag", 20];
	_box addmagazinecargoGlobal ["10Rnd_338_Mag", 10];
...
// Small Squad Supply
if (_type == 4) then {
	_box addmagazinecargoGlobal ["30Rnd_65x39_caseless_khaki_mag", 36];
	_box addmagazinecargoGlobal ["100Rnd_65x39_caseless_khaki_mag_tracer", 6];
	_box addmagazinecargoGlobal ["16Rnd_9x21_Mag", 8];
...
If (_type == 8) then {
	...
	if (isNil "SR_Night") then {SR_Night = false};
        if (SR_Night) then {
			_vehicle additemcargoGlobal ["UK3CB_BAF_1Rnd_60mm_Mo_Flare_White", 20]; 
	    };
};

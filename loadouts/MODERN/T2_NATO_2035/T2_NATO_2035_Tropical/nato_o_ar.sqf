...
for "_i" from 1 to 7 do {_unit addItemToVest "100Rnd_65x39_caseless_khaki_mag_tracer";};
_unit addItemToVest "16Rnd_9x21_Mag";
for "_i" from 1 to 4 do {_unit addItemToBackpack "SmokeShell";};
for "_i" from 1 to 3 do {_unit addItemToBackpack"100Rnd_65x39_caseless_khaki_mag_tracer";};

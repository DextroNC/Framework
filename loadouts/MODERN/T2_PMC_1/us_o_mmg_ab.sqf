...
for "_i" from 1 to 5 do {_unit addItemToBackpack "UK3CB_MG3_100rnd_762x51_RM";};
_unit addHeadgear "milgp_h_cap_backwards_02_MC";
...
if (SR_Night) then {
	...
	_unit addHeadgear "milgp_h_airframe_01_MC";

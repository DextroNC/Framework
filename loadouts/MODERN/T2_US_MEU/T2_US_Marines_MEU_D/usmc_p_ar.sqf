...
_unit addHeadgear "milgp_h_cap_backwards_05_goggles_CB";
...
for "_i" from 1 to 3 do {_unit addItemToVest "rhsusf_200Rnd_556x45_mixed_soft_pouch_coyote";};
for "_i" from 1 to 3 do {_unit addItemToBackpack "rhsusf_200Rnd_556x45_mixed_soft_pouch_coyote";};

...
comment "Add Vest/Items";
    _unit addVest selectRandom ["7r_tropen_modvest_combat","7r_tropen_modvest_recon","7r_tropen_modvest_compact"];
...
comment "Add Backpack/Items";
    _unit addBackpack "7r_compact_tropen";
    for "_i" from 1 to 2 do {_unit addItemToBackpack "DemoCharge_Remote_Mag";};
    _unit addItemToBackpack "ACE_HuntIR_monitor";
    for "_i" from 1 to 4 do {_unit addItemToBackpack "ACE_HuntIR_M203";};

comment "Add Drip";
    _unit addItemToBackpack selectRandom ["7r_beret_bw_airborne_prr","7r_beret_bw_airborne_prr_over"];

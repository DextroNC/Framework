...
this addaction ["<t color=""#FF8C00"">" +"AR sight - ZO 4x30i", "7R\Loadouts\7R_EQ.sqf",["7r_acc_zo4x30i"]];
this addaction ["<t color=""#FF8C00"">" +"MMG sight - SU-230", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_su230a"]];

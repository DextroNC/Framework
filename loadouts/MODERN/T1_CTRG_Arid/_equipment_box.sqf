...
this addaction ["<t color=""#FF8C00"">" +"ARCO", "7R\Loadouts\7R_EQ.sqf",["optic_Arco_blk_F"]];
this addaction ["<t color=""#FF8C00"">" +"ERCO", "7R\Loadouts\7R_EQ.sqf",["optic_ERCO_blk_F"]];
this addaction ["<t color=""#FF8C00"">" +"RCO", "7R\Loadouts\7R_EQ.sqf",["optic_Hamr"]];

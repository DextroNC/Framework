...
_unit addItemToBackpack "milgp_h_cap_02_MC";
...
for "_i" from 1 to 10 do {_unit addItemToVest "rhs_mag_20Rnd_SCAR_762x51_m118_special";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "rhs_mag_20Rnd_SCAR_762x51_m118_special";};

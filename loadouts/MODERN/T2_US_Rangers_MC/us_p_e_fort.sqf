...
_unit addItemToBackpack "milgp_h_cap_backwards_03_MC";
...
for "_i" from 1 to 9 do {_unit addItemToVest "rhs_mag_20Rnd_SCAR_762x51_m118_special";};
for "_i" from 1 to 3 do {_unit addItemToBackpack "rhs_mag_20Rnd_SCAR_762x51_m118_special";};

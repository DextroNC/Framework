...
_unit addHeadgear "milgp_h_cap_03_khk";
...
for "_i" from 1 to 4 do {_unit addItemToVest "UK3CB_MG3_100rnd_762x51_RM";};
for "_i" from 1 to 1 do {_unit addItemToBackpack "UK3CB_MG3_100rnd_762x51_RM";};

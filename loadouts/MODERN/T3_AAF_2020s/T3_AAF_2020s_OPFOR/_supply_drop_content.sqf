...
if (_type == 1) then {
	...
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm_polymer", 72];
	_box addmagazinecargoGlobal ["30Rnd_580x42_Mag_F", 12];
	_box addmagazinecargoGlobal ["rhs_18rnd_9x21mm_7N28", 24];
...
if (_type == 3) then {
	...
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm_polymer", 12];
	_box addmagazinecargoGlobal ["rhs_18rnd_9x21mm_7N28", 8];
	_box additemcargoGlobal ["Laserbatteries", 2];
	_box additemcargoGlobal ["ACE_UAVBattery", 2];
};
...
if (_type == 4) then {
	...
	_box addmagazinecargoGlobal ["tsp_stickCharge_auto_mag", 2];
	_box addmagazinecargoGlobal ["tsp_frameCharge_mag", 1];
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm_polymer", 36];
	_box addmagazinecargoGlobal ["30Rnd_580x42_Mag_F", 6];
	_box addmagazinecargoGlobal ["rhs_60Rnd_545X39_7N10_AK_mixed", 20];

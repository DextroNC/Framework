...
comment "Add Ammunition";
    ...
    for "_i" from 1 to 4 do {_unit addItem "uk3cb_hs50_50bmg_M33_5Rnd_magazine";};
    for "_i" from 1 to 2 do {_unit addItem "uk3cb_hs50_50bmg_MK211_5Rnd_magazine";};

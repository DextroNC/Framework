...
_unit forceAddUniform "unif_SWEAT_daguet_aloha";
...
_unit addVest "mbss_TL_tan";
for "_i" from 1 to 5 do {_unit addItemToVest "SmokeShell";};
_unit addBackpack "KIT_BAG_pince_tan";
for "_i" from 1 to 3 do {_unit addItemToBackpack "ACE_CableTie";};
for "_i" from 1 to 2 do {_unit addItemToVest "UK3CB_BAF_1Rnd_60mm_Mo_Shells";};
for "_i" from 1 to 6 do {_unit addItemToBackpack "UK3CB_BAF_1Rnd_60mm_Mo_Shells";};
_unit addHeadgear "Mich2001_snk";
_unit addGoggles "milgp_f_face_shield_goggles_shemagh_CB";

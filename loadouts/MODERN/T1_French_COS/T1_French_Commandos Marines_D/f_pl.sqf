...
_unit forceAddUniform "unif_SWEAT_serval_aloha_L";
...
_unit addBackpack "KIT_BAG_Radio_tan";
...
_unit addItemToBackpack "cap_tac_tan";
_unit addHeadgear "Maritime_L_BLK_Peltor";

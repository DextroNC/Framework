...
_unit forceAddUniform "unif_SWEAT_CE_skull";
...
_unit addBackpack "SOG_BAG_recon_OD";
for "_i" from 1 to 3 do {_unit addItemToBackpack "ACE_CableTie";};
_unit addHeadgear "Mohawk_Core_MANTA_ce";
_unit addItemToBackpack "milgp_h_cap_01_RGR";

...
this addaction ["<t color=""#00FF00"">" +"1P76 Rakurs", "7R\Loadouts\7R_EQ.sqf",["rhs_acc_rakursPM"]];
...
this addaction ["<t color=""#FF8C00"">" +"AR sight - ACOG", "7R\Loadouts\7R_EQ.sqf",["rhsusf_acc_ACOG3_USMC"]];

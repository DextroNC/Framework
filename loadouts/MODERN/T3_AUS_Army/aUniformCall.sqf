...
//Appends array of uniforms with desired uniforms based on _Class
    ...
    if (_Class == 1) then{
        _uniformArray = [
            ...
            "7r_amcu_aus_uniform2",4,
            "7r_amcu_aus_uniform2_ssl",2
        ];
    };
...
//Appends array of goggleswith desired values
    ...
    if (_Class == 1) then{
        _goggleArray = [
            ...
            "rhsusf_shemagh2_gogg_tan", 0.20,
            "rhsusf_oakley_goggles_clr", 0.15,
            "milgp_f_goggles_khk", 0.1,
            "7r_scrim_forest", 0.3,
            "UK3CB_G_Neck_Shemag_Tan", 0.2,
            "milgp_f_face_shield_shemagh_khk", 0.1,
            "milgp_f_face_shield_goggles_shemagh_khk", 0.15
        ];
    };

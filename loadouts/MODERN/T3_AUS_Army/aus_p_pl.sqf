...
comment "Add Vest/Items";
    _unit addVest "7r_mmac_teamleader_belt_amcu";
...
comment "Add Backpack/Items";
    _unit addBackpack "7r_fieldpack_amcu";
    for "_i" from 1 to 2 do {_unit addItemToBackpack "DemoCharge_Remote_Mag";};
    _unit addItemToBackpack "ACE_HuntIR_monitor";
    for "_i" from 1 to 4 do {_unit addItemToBackpack "ACE_HuntIR_M203";};

comment "Add Drip";
    _unit addItemToBackpack selectRandom ["7r_beret_aus_army_prr","7r_beret_aus_army_prr_over"];

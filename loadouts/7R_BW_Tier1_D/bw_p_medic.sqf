...
_unit addBackpack "BWA3_TacticalPack_Tropen_Medic";
...
_unit addHeadgear "milgp_h_airframe_03_khk_hexagon";
...
for "_i" from 1 to 13 do {_unit addItemToVest "rhsusf_mag_40Rnd_46x30_FMJ";};

...
_unit forceAddUniform "UK3CB_CW_SOV_O_Early_U_Sniper_Uniform_01_Ghillie_Top_KHK";
...
_unit addVest "UK3CB_V_Chestrig_TKA_OLI";
...
for "_i" from 1 to 16 do {_unit addItemToVest "rhsgref_5Rnd_762x54_m38";};

...
if (_type == 1) then {
	...
	_box addmagazinecargoGlobal ["rhs_mag_762x25_8", 24];
	_box addmagazinecargoGlobal ["SR_60Rnd_545x39_rpk", 40];
	_box addmagazinecargoGlobal ["rhs_100Rnd_762x54mmR", 8];
	_box addmagazinecargoGlobal ["rhsgref_20rnd_765x17_vz61", 5];
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm_bakelite", 20];
...
if (_type == 3) then {
	...
	_box addmagazinecargoGlobal ["rhs_30Rnd_545x39_7N6M_AK", 8];
	_box addmagazinecargoGlobal ["rhs_mag_9x18_8_57N181S", 10];
	_box addmagazinecargoGlobal ["rhsgref_5Rnd_762x54_m38", 12];
};

// Small Squad Supply
if (_type == 4) then {
	_box addmagazinecargoGlobal ["rhs_30Rnd_545x39_7N6M_plum_AK", 36];
...
if (_type == 5) then {
	_box addWeaponcargoGlobal ["rhs_weap_rpg26", 2];
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm_bakelite", 6];
	_box addmagazinecargoGlobal ["rhs_100Rnd_762x54mmR", 5];
	_box addmagazinecargoGlobal ["rhsgref_20rnd_765x17_vz61", 2];

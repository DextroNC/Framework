...
_unit addHeadgear "UK3CB_ABP_B_H_6b27m_ess_DES";
...
for "_i" from 1 to 5 do {_unit addItemToVest "UK3CB_RPK_75Rnd_Drum";};
for "_i" from 1 to 10 do {_unit addItemToBackpack "UK3CB_RPK_75Rnd_Drum";};

...
if (_type == 1) then {
	...
	_box addmagazinecargoGlobal ["RH_15Rnd_9x19_SIG", 24];
	_box addmagazinecargoGlobal ["UK3CB_RPK_75Rnd_Drum", 40];
	_box addmagazinecargoGlobal ["rhsusf_100Rnd_762x51", 8];
	_box addmagazinecargoGlobal ["30Rnd_9x21_Mag", 15];
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm", 25];
...
if (_type == 3) then {
	...
	_box addmagazinecargoGlobal ["30Rnd_9x21_Mag", 8];
...
if (_type == 4) then {
	...
	_box addmagazinecargoGlobal ["UK3CB_RPK_75Rnd_Drum", 20];
	_box addmagazinecargoGlobal ["30Rnd_9x21_Mag", 8];
...
if (_type == 5) then {
	...
	_box addmagazinecargoGlobal ["30Rnd_9x21_Mag", 2];

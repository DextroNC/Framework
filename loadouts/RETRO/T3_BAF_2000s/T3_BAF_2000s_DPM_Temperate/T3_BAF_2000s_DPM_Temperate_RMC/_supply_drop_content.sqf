...
if (_type == 1) then {
	...
	_box addmagazinecargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_Stanag", 96];
	...
	_box addmagazinecargoGlobal ["UK3CB_BAF_338_5Rnd", 15];
	_box addMagazineCargoGlobal ["rhs_weap_m72a7", 6];

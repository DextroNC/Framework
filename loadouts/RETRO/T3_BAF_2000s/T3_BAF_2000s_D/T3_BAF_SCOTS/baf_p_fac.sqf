...
comment "Add Vest/Items";
    _unit addVest selectRandom ["UK3CB_BAF_V_Osprey_DDPM2","UK3CB_BAF_V_Osprey_DDPM5","UK3CB_BAF_V_Osprey_DDPM6","UK3CB_BAF_V_Osprey_DDPM7","UK3CB_BAF_V_Osprey_DDPM8"];
...
comment "Add Backpack/Items";
    _unit addBackpack "UK3CB_BAF_B_Bergen_DDPM_JTAC_H_A";
    _unit addItemToBackpack "Laserbatteries";
    _unit addItemToBackpack "ACRE_PRC117F";

comment "Add Drip";
    _unit addItemToBackpack "UK3CB_BAF_H_Beret_SG_PRR";
...
if (SR_Night) then {
    _unit linkItem selectRandom ["USP_PVS14", "USP_PVS14_TAR"];

...
comment "Add Vest/Items";
    _unit addVest selectRandom ["UK3CB_BAF_V_Osprey_DPMT2","UK3CB_BAF_V_Osprey_DPMT5","UK3CB_BAF_V_Osprey_DPMT6","UK3CB_BAF_V_Osprey_DPMT7","UK3CB_BAF_V_Osprey_DPMT8"];
...
comment "Add Backpack/Items";
    _unit addBackpack "UK3CB_BAF_B_Bergen_DPMT_JTAC_H_A";
    _unit addItemToBackpack "Laserbatteries";
    _unit addItemToBackpack "ACRE_PRC117F";

comment "Add Drip";
    _unit addItemToBackpack "UK3CB_BAF_H_BERET_PR_PRR";

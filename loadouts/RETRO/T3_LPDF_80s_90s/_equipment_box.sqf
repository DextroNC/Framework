this addaction ["<t color=""#FF8C00"">" +"NIT-A", "7R\Loadouts\7R_EQ.sqf",["rhs_acc_nita"]];
this addaction ["<t color=""#FF8C00"">" +"1p78", "7R\Loadouts\7R_EQ.sqf",["rhs_acc_1p78"]];
this addaction ["<t color=""#FF8C00"">" +"1p29", "7R\Loadouts\7R_EQ.sqf",["rhs_acc_1p29"]];

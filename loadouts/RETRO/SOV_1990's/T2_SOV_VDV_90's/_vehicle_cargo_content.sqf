...
switch (_index) do {
	...
	case 3: {
		_vehicle addItemCargoGlobal ["SR_PAK", 4];
		_vehicle addbackpackcargoGlobal ["RHS_Metis_Gun_Bag", 1];
	    _vehicle addbackpackcargoGlobal ["RHS_Metis_Tripod_Bag", 1];
		_vehicle addMagazineCargoGlobal ["Vorona_HE", 2];
		_vehicle addMagazineCargoGlobal ["Vorona_HEAT", 4];

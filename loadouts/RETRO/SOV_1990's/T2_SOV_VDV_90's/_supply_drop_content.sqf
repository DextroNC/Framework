...
// Infantry Supply
if (_type == 1) then {
	_box addmagazinecargoGlobal ["rhs_30Rnd_545x39_7N6M_plum_AK", 72];
	_box addmagazinecargoGlobal ["rhs_mag_9x18_8_57N181S", 24];
	_box addmagazinecargoGlobal ["rhs_45Rnd_545X39_AK_Green", 60];
	_box addmagazinecargoGlobal ["rhs_100Rnd_762x54mmR_green", 8];
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm", 18];
...
if (_type == 3) then {
	...
	_box addmagazinecargoGlobal ["rhs_5Rnd_338lapua_t5000", 10];  
};

// Small Squad Supply
if (_type == 4) then {
	_box addmagazinecargoGlobal ["rhs_30Rnd_545x39_7N6M_AK", 36];
	_box addmagazinecargoGlobal ["rhs_45Rnd_545X39_AK_Green", 25];
	_box addmagazinecargoGlobal ["rhs_mag_9x18_8_57N181S", 8];
...
if (_type == 5) then {
	_box addWeaponcargoGlobal ["rhs_weap_rpg26", 2];
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm", 10];
	...
	_box addbackpackcargoGlobal ["RHS_Metis_Tripod_Bag", 1];
	_box addbackpackcargoGlobal ["RHS_Metis_Gun_Bag", 1];
};

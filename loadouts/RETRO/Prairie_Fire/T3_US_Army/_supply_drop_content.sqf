...
// Infantry Supply
if (_type == 1) then {
	_box addmagazinecargoGlobal ["vn_m16_20_mag", 120];
	_box addmagazinecargoGlobal ["vn_m1911_mag", 24];
	_box addmagazinecargoGlobal ["vn_m63a_150_mag", 30];
	_box addmagazinecargoGlobal ["vn_m60_100_mag", 12];
	_box addmagazinecargoGlobal ["20Rnd_762x51_Mag", 40];
	_box addmagazinecargoGlobal ["vn_m1918_mag", 24];
	_box addmagazinecargoGlobal ["vn_m63a_30_mag", 24];
	_box addmagazinecargoGlobal ["vn_m3a1_mag", 12];
	_box addmagazinecargoGlobal ["vn_m1928_mag", 24];
	_box addmagazinecargoGlobal ["vn_carbine_30_mag", 24];
	_box addmagazinecargoGlobal ["MRAWS_HEAT_F", 5];
	_box addmagazinecargoGlobal ["MRAWS_HE_F", 3];
	_box addWeaponcargoGlobal ["vn_m72", 10];
	...
	_box additemcargoGlobal ["vn_40mm_m406_he_mag", 20];
	_box additemcargoGlobal ["vn_40mm_m680_smoke_w_mag", 20];
	_box additemcargoGlobal ["vn_40mm_m583_flare_w_mag", 20];
	_box additemcargoGlobal ["vn_40mm_m662_flare_r_mag", 20];
...
// Small Squad Supply
if (_type == 4) then {
	_box addmagazinecargoGlobal ["vn_m16_20_mag", 36];
	_box addmagazinecargoGlobal ["vn_m63a_150_mag", 6];
	_box addmagazinecargoGlobal ["vn_m1911_mag", 8];
...
if (_type == 5) then {
	_box addWeaponcargoGlobal ["vn_m72", 2];
	_box addmagazinecargoGlobal ["rhs_mag_20Rnd_SCAR_762x51_m118_special", 8];
	_box addmagazinecargoGlobal ["20Rnd_762x51_Mag", 10];

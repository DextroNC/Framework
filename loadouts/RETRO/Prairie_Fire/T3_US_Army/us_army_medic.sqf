...
for "_i" from 1 to 9 do {_unit addItemToVest "vn_m16_20_mag";};
for "_i" from 1 to 4 do {_unit addItemToBackpack "vn_m16_20_mag";};
for "_i" from 1 to 3 do {_unit addItemToBackpack "ACE_CableTie";};
_unit addHeadgear "vn_b_helmet_m1_07_01";

...
_unit forceAddUniform "UK3CB_BAF_U_CombatUniform_DDPM_ShortSleeve_RM";
...
_unit addVest "UK3CB_BAF_V_Osprey_DDPM5";
for "_i" from 1 to 3 do {_unit addItemToVest "SmokeShell";};
_unit addBackpack "UK3CB_BAF_B_Bergen_DDPM_Rifleman_B";
for "_i" from 1 to 3 do {_unit addItemToBackpack "ACE_CableTie";};
for "_i" from 1 to 6 do {_unit addItemToBackpack "UK3CB_BAF_338_5Rnd";};
...
_unit addHeadgear "UK3CB_BAF_H_Mk6_DDPM_d";

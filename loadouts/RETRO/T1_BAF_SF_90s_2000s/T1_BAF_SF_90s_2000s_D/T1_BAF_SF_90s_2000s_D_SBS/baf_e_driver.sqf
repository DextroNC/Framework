...
comment "Add Backpack/Items";
    SR_dpmTop = _unit getVariable ["SR_dpmTop",false];
    if SR_dpmTop then {
        _unit addBackpack selectRandom ["UK3CB_BAF_B_Bergen_dpmt_Rifleman_A","UK3CB_BAF_B_Bergen_dpmt_Rifleman_B"];
    } else {
        _unit addBackpack selectRandom ["UK3CB_BAF_B_Bergen_ddpm_Rifleman_A","UK3CB_BAF_B_Bergen_ddpm_Rifleman_B"];
    };

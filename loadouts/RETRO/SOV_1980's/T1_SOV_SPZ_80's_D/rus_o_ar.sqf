...
_unit addHeadgear "UK3CB_H_Beanie_02_BRN";
...
for "_i" from 1 to 5 do {_unit addItemToVest "UK3CB_RPK_75rnd_762x39_GT";};
for "_i" from 1 to 11 do {_unit addItemToBackpack "UK3CB_RPK_75rnd_762x39_GT";};

...
// Infantry Supply
if (_type == 1) then {
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm_bakelite", 72];
	_box addmagazinecargoGlobal ["rhs_mag_9x18_8_57N181S", 24];
	_box addmagazinecargoGlobal ["UK3CB_RPK_75rnd_762x39_GT", 60];
...
if (_type == 3) then {
	...
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm_bakelite", 12];
};

// Small Squad Supply
if (_type == 4) then {
	_box addmagazinecargoGlobal ["rhs_30Rnd_762x39mm_bakelite", 36];
	_box addmagazinecargoGlobal ["UK3CB_RPK_75rnd_762x39_GT", 25];
	_box addmagazinecargoGlobal ["rhs_mag_9x18_8_57N181S", 8];

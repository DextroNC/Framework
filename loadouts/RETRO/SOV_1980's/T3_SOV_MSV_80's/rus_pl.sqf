...
for "_i" from 1 to 4 do {_unit addItemToBackpack "rhs_mag_nspd";};
...
_unit addHeadgear "UK3CB_CW_SOV_O_EARLY_H_Officer_Cap";
...
for "_i" from 1 to 7 do {_unit addItemToBackpack "rhs_30Rnd_545x39_7N6M_AK";};
...
if (SR_Night) then {
	...
	_unit addItemToBackpack "UK3CB_CW_SOV_O_EARLY_H_Officer_Cap";
};

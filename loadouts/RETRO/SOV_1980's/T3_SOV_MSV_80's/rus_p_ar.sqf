...
_unit addItemToBackpack "rhs_pilotka";
...
for "_i" from 1 to 5 do {_unit addItemToVest "UK3CB_AK47_45Rnd_Magazine_GT";};
for "_i" from 1 to 15 do {_unit addItemToBackpack "UK3CB_AK47_45Rnd_Magazine_GT";};

...
comment "Add Drip";
    _unit addItemToBackpack selectRandom ["rhsusf_bowman_cap","milgp_h_cap_backwards_02_RGR","H_Cap_headphones","milgp_h_cap_backwards_02_khk"];
...
if (SR_Night) then {
    _unit linkItem selectRandom ["USP_PVS15_TAR","USP_PVS15"];

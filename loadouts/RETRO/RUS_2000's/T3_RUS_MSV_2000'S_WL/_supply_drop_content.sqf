...
if (_type == 1) then {
	...
	_box addmagazinecargoGlobal ["rhs_45Rnd_545X39_7N22_AK", 40];
	...
	_box additemcargoGlobal ["rhs_ec200_mag", 4];
...
if (_type == 4) then {
	...
	_box addmagazinecargoGlobal ["rhs_45Rnd_545X39_7N22_AK", 20];
...
if (_type == 5) then {
	...
	_box additemcargoGlobal ["rhs_ec200_mag", 2];
	_box additemcargoGlobal ["rhs_ec400_mag", 1];

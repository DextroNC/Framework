...
for "_i" from 1 to 5 do {_unit addItemToVest "UK3CB_BAF_12G_Pellets";};
_unit addBackpack "UK3CB_BAF_B_Bergen_MTP_PointMan_L_A";
for "_i" from 1 to 3 do {_unit addItemToBackpack "ACE_CableTie";};
_unit addItemToBackpack "RH_SFM952V";
_unit addItemToBackpack "UK3CB_BAF_L128A1";
for "_i" from 1 to 2 do {_unit addItemToBackpack "DemoCharge_Remote_Mag";};
for "_i" from 1 to 3 do {_unit addItemToBackpack "UK3CB_BAF_12G_Pellets";};
for "_i" from 1 to 8 do {_unit addItemToBackpack "UK3CB_BAF_12G_Slugs";};
_unit addHeadgear "UK3CB_BAF_H_Mk7_Camo_CESS_C";
